...
- `CUBE_OVERLAY_ANCHOR_R` / `_B` — persistent bottom-right anchor; width/height changes pivot from here (window grows up + left).
- `CUBE_OVERLAY_RESET_R` / `_B` — Reset-menu landing anchor (default 3838/1030 = primary-monitor right-bottom in the WSLg dual-monitor layout).
